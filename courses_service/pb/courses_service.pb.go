...
type Course struct {
	...
	Credits int64  `protobuf:"varint,4,opt,name=year,proto3" json:"year,omitempty"`
...
var (
	...
	file_courses_service_proto_rawDescData = file_phones_service_proto_rawDesc
)
...
var file_courses_service_proto_depIdxs = []int32{
	...
	3, // 1: GetCourse:input_type -> auth.CourseId
	0, // 2: GetCourses:input_type -> auth.GetCoursesRequest
	2, // 3: CreateCourse:input_type -> auth.Course
	3, // 4: DeleteCourse:input_type -> auth.CourseId
	2, // 5: UpdateCourse:input_type -> auth.Course
	2, // 6: GetCourse:output_type -> auth.Course
	1, // 7: GetCourses:output_type -> auth.CourseList
	2, // 8: CreateCourse:output_type -> auth.Course
	2, // 9: DeleteCourse:output_type -> auth.Course
	2, // 10: UpdateCourse:output_type -> auth.Course
